...
//!
//! A fast, portable log colorizer with support for 59 programs across 9 categories.
//!
//! ## Features
//!
//! - 59 built-in program configurations (Ethereum, DevOps, Dev, Network, Data, etc.)
...
pub mod prelude {
    pub use crate::{
        Client, Color, ColorSpec, Colorizer, Config, Program, ProgramInfo, ProgramRegistry, Rule,
