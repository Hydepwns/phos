...
#[must_use] pub fn rust_log_levels() -> Vec<Rule> {
    vec![
...
#[must_use] pub fn lighthouse_log_levels() -> Vec<Rule> {
    vec![
...
#[must_use] pub fn nimbus_log_levels() -> Vec<Rule> {
    vec![
...
#[must_use] pub fn lodestar_log_levels() -> Vec<Rule> {
    vec![
...
#[must_use] pub fn prysm_log_levels() -> Vec<Rule> {
    vec![
...
#[must_use] pub fn dotnet_log_levels() -> Vec<Rule> {
    vec![
        Rule::new(r"\bError\b").unwrap().semantic(SemanticColor::Error).bold().build(),
        Rule::new(r"\bWarn\b").unwrap().semantic(SemanticColor::Warn).bold().build(),
        Rule::new(r"\bInfo\b").unwrap().semantic(SemanticColor::Info).build(),
...
#[must_use] pub fn erigon_log_levels() -> Vec<Rule> {
    vec![
...
#[must_use] pub fn elixir_log_levels() -> Vec<Rule> {
    vec![
...
#[must_use] pub fn hash_rule() -> Rule {
...
#[must_use] pub fn address_rule() -> Rule {
...
#[must_use] pub fn slot_rule() -> Rule {
...
#[must_use] pub fn epoch_rule() -> Rule {
...
#[must_use] pub fn peers_rule() -> Rule {
...
#[must_use] pub fn syncing_rule() -> Rule {
...
#[must_use] pub fn success_rule() -> Rule {
...
#[must_use] pub fn failure_rule() -> Rule {
...
#[must_use] pub fn validator_rule() -> Rule {
...
#[must_use] pub fn pubkey_rule() -> Rule {
...
#[must_use] pub fn duty_rule() -> Rule {
...
#[must_use] pub fn committee_rule() -> Rule {
...
#[must_use] pub fn finality_rule() -> Rule {
...
#[must_use] pub fn root_rule() -> Rule {
...
#[must_use] pub fn attestation_rule() -> Rule {
...
#[must_use] pub fn mev_value_rule() -> Rule {
...
#[must_use] pub fn relay_rule() -> Rule {
...
#[must_use] pub fn builder_rule() -> Rule {
...
#[must_use] pub fn consensus_patterns() -> Vec<Rule> {
    vec![
        slot_rule(),
        epoch_rule(),
...
#[must_use] pub fn execution_patterns() -> Vec<Rule> {
    vec![
        address_rule(), // Before hash_rule for specific address matching
        hash_rule(),
        peers_rule(),
...
/// MEV/relay patterns
#[must_use] pub fn mev_patterns() -> Vec<Rule> {
    vec![
        mev_value_rule(),
        relay_rule(),
        builder_rule(),
...
mod tests {
    ...
    fn test_address_rule_matches_40_hex() {
        ...
        assert!(rule_matches(&rule, "0x742d35Cc6634C0532925a3b844Bc9e7595f12345"));
        assert!(rule_matches(&rule, "0x0000000000000000000000000000000000000000"));
    }
    ...
    fn test_execution_patterns_not_empty() {
        ...
        assert!(!patterns.is_empty());
        assert!(patterns.iter().any(|r| rule_matches(r, "peers=50")));
        assert!(patterns.iter().any(|r| rule_matches(r, "0x1234567890abcdef")));
    }
    ...
    fn test_address_rule_39_chars_fails() {
        ...
        assert!(!rule_matches(&rule, "0x742d35Cc6634C0532925a3b844Bc9e7595f1234"));
    }
    ...
    fn test_address_rule_mixed_case() {
        ...
        assert!(rule_matches(&rule, "0xAbCdEf1234567890AbCdEf1234567890AbCdEf12"));
        // All lowercase
        assert!(rule_matches(&rule, "0xabcdef1234567890abcdef1234567890abcdef12"));
        // All uppercase
        assert!(rule_matches(&rule, "0xABCDEF1234567890ABCDEF1234567890ABCDEF12"));
    ...
    fn test_root_rule_64_hex() {
        let rule = root_rule();
        let state_root = "state_root=0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef";
        let block_root = "block_root=0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef";
